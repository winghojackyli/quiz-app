  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Quiz App!</DialogTitle>
          <DialogDescription>
            <div className="flex items-center gap-3 my-2">
              <p className="flex items-center">
                ...
                <Link
                  ...
                  href="https://github.com/winghojackyli/quiz-app"
                >
                  GitHub
                </Link>
              </p>
            </div>
            <p className="my-2 mt-4 py-2">
              Enter Quiz App, where ordinary quizzes transform into
              extraordinary experiences! Tired of mundane repetition? Our
              platform revolutionizes trivia using advanced artificial
              intelligence, ensuring an engaging and novel quiz journey.
            </p>
            <hr />
